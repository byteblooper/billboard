...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 17a2 2 0 114 0m-4 0a2 2 0 10-4 0m4 0a2 2 0 104 0m-5 4h6a3 3 0 003-3v-4a3 3 0 00-3-3h-1.42a2.31 2.31 0 01-.16-.52l-.83-2.49A1.5 1.5 0 0012.11 6H9.89a1.5 1.5 0 00-1.42" />
        </svg>),
  },
    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-gray-200 shadow-sm">
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Billboard</h1>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">admin@billboard.com</p>
            </div>
