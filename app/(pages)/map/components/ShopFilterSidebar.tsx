      ...
      <div className={`${
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200">
          ...
          <div className="space-y-6">
            {/* Search by Shop Name */}
            <div>
              <h3 className="font-semibold text-slate-800 mb-3">Search Shop</h3>
            ...
            {/* Distance Range */}
            <div>
              <h3 className="font-semibold text-slate-800 mb-3">Distance Range (km)</h3>
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 text-orange-500 focus:ring-orange-500"
                  />
                  <span className="text-slate-700 group-hover:text-orange-600">All Shops</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    type="radio"
                    ...
                    className="w-4 h-4 text-orange-500 focus:ring-orange-500"
                  />
                  <span className="text-slate-700 group-hover:text-orange-600">Open Now</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    type="radio"
                    ...
                    className="w-4 h-4 text-orange-500 focus:ring-orange-500"
                  />
                  <span className="text-slate-700 group-hover:text-orange-600">Closed</span>
                </label>
              </div>
            </div>
            ...
            {/* Verified Only */}
            <div>
              <h3 className="font-semibold text-slate-800 mb-3">Verification</h3>
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  type="checkbox"
                ...
                />
                <span className="text-slate-700 group-hover:text-orange-600">Verified Shops Only</span>
              </label>
            </div>
          </div>
        </div>
