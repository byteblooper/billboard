      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Wishlist */}
            <button className="relative p-2.5 hover:bg-slate-50 rounded-lg transition-all duration-200 group">
            ...
            {/* Profile */}
            <button className="p-2.5 hover:bg-slate-50 rounded-lg transition-colors group">
