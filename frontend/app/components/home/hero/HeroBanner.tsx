  ...
  const heroProducts = [
    ...
    },
    {
      ...
      badge: {
        ...
        color: "bg-gradient-to-r from-indigo-400 to-violet-600",
        tag: "EXCLUSIVE",
      },
  ...
  return (
    <div className="bg-violet-50 w-full">
      ...
      <div className="relative">
        <div className="relative h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] bg-gradient-to-r from-indigo-900 via-indigo-800 to-indigo-900">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/90 via-indigo-900/60 to-transparent"></div>
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 h-full flex items-center">
            <div className="max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl">
              <div className="inline-block mb-4 sm:mb-6">
                <div className="bg-violet-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-md font-bold text-sm sm:text-lg shadow-lg">
              ...
              <div className="flex flex-wrap items-baseline gap-2 sm:gap-4 mb-4 sm:mb-6">
                ...
                <span className="text-indigo-300 text-base sm:text-xl line-through">
                  ${currentProduct.originalPrice}
                </span>
                <div className="flex items-center gap-1 bg-violet-500 px-2 py-1 rounded-full">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
                {currentProduct.specs.map((spec, index) => (
                  <div
                    key={index}
                    className="bg-indigo-700/80 backdrop-blur-sm text-white px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium border border-indigo-600"
                  >
                    {spec}
                  </div>
                ))}
        ...
        {/* Slide Indicators */}
        <div className="absolute bottom-6 left-1/2 transform -tranviolet-x-1/2 flex gap-2 sm:gap-3 z-10 hidden sm:flex">
