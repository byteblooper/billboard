...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br from-cyan-50 via-cyan-100 to-cyan-50 pb-20 sm:pb-24 md:pb-28 lg:pb-32 py-10 overflow-hidden">
      {/* Flash Sale Section */}
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-left duration-700">
            ...
            <div
              className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm px-5 sm:px-6 py-3 rounded-full shadow-lg 
                            hover:shadow-xl transition-shadow duration-300 border border-cyan-200"
            >
              <Sun className="w-5 h-5 text-cyan-600 animate-pulse" />
            ...
            <div className="space-y-1 sm:space-y-2">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-cyan-700 leading-tight">
                Premium
              </h1>

              <h2
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold 
                            bg-gradient-to-r from-cyan-600 via-cyan-400 to-cyan-500 
            ...
            {/* Subheading */}
            <p className="text-base sm:text-lg md:text-xl text-cyan-700 font-medium max-w-md leading-relaxed">
              Verified stores within{" "}
              <span className="text-cyan-600 font-bold">50km</span>. Real-time
              tracking and{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                className="group flex items-center justify-center gap-3 
                                 bg-white/60 hover:bg-white/80 text-cyan-700 
                                 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold 
                                 text-base sm:text-lg border-2 border-cyan-300 
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-4 sm:pt-6">
              <div
                className="bg-white/50 backdrop-blur-md rounded-2xl p-3 sm:p-4 shadow-md 
                              hover:shadow-lg transition-shadow duration-300 border border-cyan-200 text-center"
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-600 mb-1">
                  50km
                </div>
              ...
              <div
                className="bg-white/50 backdrop-blur-md rounded-2xl p-3 sm:p-4 shadow-md 
                              hover:shadow-lg transition-shadow duration-300 border border-cyan-200 
                              flex items-center justify-center"
              >
                <BadgeCheck className="text-cyan-600 w-6 h-6 sm:w-7 sm:h-7 mr-2" />
                <div className="text-cyan-700 font-medium text-xs sm:text-sm">
                  Verified
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 animate-in fade-in slide-in-from-right duration-700">
            <div
              className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl 
                            hover:shadow-3xl transition-shadow duration-300 border border-cyan-200/40"
            >
              <HeroBanner />
            </div>
          </div>
