...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#E6E6FA] py-2 px-1 sm:px-4 lg:py-0 lg:px-0 lg:border-b lg:border-gray-200">
      ...
      <div className="w-full max-w-7xl mx-auto sm:px-4 lg:px-6 py-2.5 lg:py-3 flex items-center justify-between gap-2 bg-white border-1 border-[#8140DF]  lg:border-none lg:rounded-none lg:bg-transparent shadow-sm lg:shadow-none">
