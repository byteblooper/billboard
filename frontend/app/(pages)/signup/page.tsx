      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-violet-800 mb-2">Create Account</h2>
              <p className="text-violet-600">Join us to discover amazing local deals</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -tranviolet-y-1/2 w-5 h-5 text-violet-400" />
                  <input
                    type="text"
                    name="fullName"
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-5 h-5 mt-0.5 text-violet-500 border-violet-300 rounded focus:ring-violet-500"
                />
            ...
            <p className="mt-8 text-center text-violet-600">
              ...
              <Link href="/signin" className="text-violet-600 hover:text-violet-700 font-bold">
                Sign In
              </Link>
            </p>
          </div>
