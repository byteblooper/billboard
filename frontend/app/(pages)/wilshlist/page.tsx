          ...
          {wishlistItems.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-3">
                ...
                <p className="text-xl font-bold text-slate-900">${totalSavings.toFixed(0)}</p>
              </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-3 left-3 z-10">
                    <input
                      ...
                      className="w-5 h-5 text-orange-500 border-slate-300 rounded focus:ring-orange-500 cursor-pointer"
                    />
                  </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-medium text-orange-600">{item.store}</span>
                      {item.verified && (
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2.5 border border-slate-300 text-slate-600 rounded-lg hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors"
                    >
                      <Trash2 className="w-4 h-4" />
                    </button>
                  </div>
