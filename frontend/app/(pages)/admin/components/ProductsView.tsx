    ...
    <div className="bg-white rounded-lg border border-slate-200">
      <div className="p-4 border-b border-slate-200">
        <div className="flex items-center justify-between gap-4 mb-4">
          <h2 className="font-semibold text-slate-900">Products Management</h2>
        ...
        <table className="w-full">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="text-left p-4 text-xs font-semibold text-slate-600">Price</th>
              <th className="text-left p-4 text-xs font-semibold text-slate-600">Stock</th>
          ...
          <tbody className="divide-y divide-slate-200">
            {filteredProducts.map((product) => (
              <tr key={product.id} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="p-4 text-sm font-semibold text-slate-900">${product.price}</td>
                <td className="p-4 text-sm text-slate-600">{product.stock}</td>
